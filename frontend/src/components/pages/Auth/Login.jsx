          ...
          <div className="p-6 w-[332px] pb-[80px] border rounded-lg">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col w-[100%]">
              ...
              <div className="flex justify-between text-sm">
                ...
                <Link
                  className="hover:text-[#009CC2] transition ease-out duration-400"
                  to="/register"
                >
                  Esqueceu a senha ?
                </Link>
              ...
              <input
                className="rounded-lg font-bold text-white py-3 w-[100%] bg-[#009CC2] hover:bg-[#00556b] transition ease-out duration-400 cursor-pointer"
                type="submit"
                value="Log in"
              />
            </form>
