            ...
            {company.length > 0 ? company.map((company) => (
                <div className='flex items-center justify-between mx-[50px] mt-[20px] border-b-2 border-[#737272] pb-3 text-md' key={company._id}>
                    ...
                    <div>
                        ...
                        <button className="text-white bg-[#009cc2] hover:bg-[#005469] duration-400 transition ease-in-out py-2 px-4 rounded mr-3"><Link to={`/solucoes/edit/${company._id}`}>Editar</Link></button>
                        <button className="text-white bg-[#009cc2] hover:bg-[#005469] duration-400 transition ease-in-out py-2 px-4 rounded"><Link to={`/solucoes/edit/${company._id}`}>Convidar usuário</Link></button>
                    </div>
                </div>
            )) :  
