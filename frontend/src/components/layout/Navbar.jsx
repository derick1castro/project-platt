  ...
  return (
    <nav className='flex justify-between py-4 px-6 border-b-2'>
      ...
      <ul className='flex items-center list-none'>
        ...
        <li className='cursor-pointer font-medium py-2 px-3 text-[#68787b] hover:text-[#00abd6] transition ease-in-out duration-400 hover:border-b-2 hover:border-[#00abd6]' onClick={logout}>Logout</li>
      </ul>
      ) : ('')}
